...
function init() {
  ...
  for (var i = 0; i < 500; i++) {
    var radius = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomRadius"])(10, 20);
    ...
    ballArray.push(new Ball(x, y, dx, dy, radius, Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomColor"])(colors)));
  }
...
var randomRadius = function randomRadius(min, max) {
  return Math.floor(Math.random() * (max - min + 1) + min);
};
